...
plotTitle = strjoin(["Temperature Data for Bowl with",newline,"Radius Ratio:",str2double(split_array(1))/100,", Specimen ",split_array(2)]);
...
plot(time, temperature, '^', 'Color', colpos(1,:),'DisplayName','Temperature');
...
line(xLine, yLimits, 'Color', 'r', 'LineStyle', '--', 'LineWidth', 2,'DisplayName','Start of Deformation'); % Red dashed line with thickness 2
end
line(meanplotx, meanploty, 'Color', 'b', 'LineStyle', '-', 'LineWidth', 1,"DisplayName",'Mean Temperature'); % Red dashed line with thickness 2
box on
