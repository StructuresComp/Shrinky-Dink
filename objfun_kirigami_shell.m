function objfun_kirigami_shell(main_dimension, temp_in, temp_final, ...
...
inputName = sprintf( [inputNameString, '%d.inp'], main_dimension*1000);
...
nodesFile = sprintf( 'r-nodes-%d.inp', main_dimension*1000);

% Boundary condition file
bcFile = sprintf( 'r-boundaryCondition-%d.inp', main_dimension*1000);
%% Create an input (.inp) file
write_input_file(inputName, nodesFile, bcFile, temp_final, mat_param); 
